...
<html>
  ...
  <body>
    ...
    <?php
    $resultajoueur = $pdo->AffichClubsderoul();
    ;
    ?> 
    ...
    <table class =' tablecent table-borderless table-condensed table-hover'>
      ...
      <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF'], ENT_QUOTES); ?>" method="post">
        <tr>
          <td>Nom : </td> 
          <td><input type = 'text' name='mnomClub' value ="<?php echo $resultajoueur[0]['NOMCLUB'];?>"> </td>
        </tr>
        <tr>
          <td>Ville : </td>
          <td><input type = 'text' name='mvilleClub' value ="<?php echo $resultajoueur[0]['VILLECLUB'];?>"> </td>
        </tr>
        <tr>
          <td>Pays : </td>
          <td><input type = 'text' name='mpaysClub' value ="<?php echo $resultajoueur[0]['PAYSCLUB'];?>"> </td>
        </tr>
        <tr>
          <td></td>
