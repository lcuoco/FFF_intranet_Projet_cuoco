<html>
  ...
  <body><div class = "container">
    <div class="row">
            ...
            <button type="submit" class="btn btn-danger" name="retourc" value="Retourner" style='margin-bottom: 10px; margin-left: 10px;'><span class="glyphicon glyphicon-circle-arrow-left"></span> Retour</button></form>
