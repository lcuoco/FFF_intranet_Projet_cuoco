<!--
Fichier acceuil-view.inc.php qui contient la vue d'acceuil de base quadn l'utilisatuer est connecté et localisé dans le dossier views
de FFF_intranet

Cette vue permet notement de visualiser l'acceul du site
-->
