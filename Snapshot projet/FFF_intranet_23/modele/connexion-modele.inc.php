<?php
/** 
* Fichier connexion-modele.inc.php qui contient la classe de connexion à la base et toutes le fonction utile au fonctionnemet
* de FFF_intranet
*
*/
         ...
         */
            ...
            */
            function SuppClub($csupp)
            {
                ...
                $suppClub = PdoFFF::$monPdo->query('DELETE FROM CLUB WHERE IDCLUB = "'.$csupp.'"');
