...
--
-- Hôte : localhost:8889
-- Généré le :  lun. 08 jan. 2018 à 09:48
...
(78, 3, 'Lucas', 'Cuoco', '2 allée Micheline Ostermeyer', '57970', 'Yutz', 'France', 'lucas.cuoco@gmail.com', '0789765432', 20, 1, 1),
...
(101, 3, 'Pignon', 'Marcel', '5 rue d\'Allemagne', '58907', 'Frabi', 'France', 'pignon.m@gmail.com', '0798876543', 25, 2, 43),
...
(112, 1, 'Patrick', 'Genter', '2 rue du Sac de billes', '56890', 'Mondelage', 'France', 'patrick.genter@gmail.com', '0678875456', 16, 2, 59),
(113, 1, 'Alexis', 'O\'Maley', '2 rue du glanda', '58900', 'Mayar', 'France', 'a.om@gmail.com', '0898765432', 26, 1, 63);
...
--
ALTER TABLE `INSCRIPTION`
  MODIFY `IDINSCRIPTION` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;
--
-- AUTO_INCREMENT pour la table `JOUEUR`
--
ALTER TABLE `JOUEUR`
  MODIFY `IDJOUEUR` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=114;
--
-- AUTO_INCREMENT pour la table `LICENCE`
--
ALTER TABLE `LICENCE`
  MODIFY `IDLICENCE` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=68;
--
