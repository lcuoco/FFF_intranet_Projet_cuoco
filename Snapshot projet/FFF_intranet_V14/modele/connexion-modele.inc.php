...
function AffichJoueurs()
     {
        ...
        $idfnc = array();
        $i=0;
        echo("<div class ='text-center'><h5>Liste des Joueur</h5></div><div class ='tableov'><small><h6> <form method='post'><table class = 'tableov table table-bordered table-striped table-hover '>
  ...
  function CreaJoueurs($jcateg, $jnom, $jprenom, $jadresse = NULL, $jcp = NULL, $jville = NULL, $jpays = NULL, $jemail = NULL, $jtel = null, $jclub)
      ...
      function AffichClubs()
     {
        ...
        echo("<form method='post'>
            <div class ='text-center'><h5>Liste des Clubs</h5></div><div class ='tableov'><small><h6> <form method='post'><table class = 'tableov table table-bordered table-striped table-hover hiddens' style ='width:100%;'>
            <tr class ='text-center'>
