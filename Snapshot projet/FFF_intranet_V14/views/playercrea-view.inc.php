					...
					<?php AffichJoueurs();?>
							...
							<div class="col-lg-3 well well-sm" style ="margin-left: 25px;">
								<table class ='table-borderless table-condensed table-hover'>
									<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF'], ENT_QUOTES); ?>" method="post">
										<div class ="text-center"><h5>Historique</h5>
										</div>
								...
								<div class="col-lg-3 well well-sm" style ="margin-left: 10px;">
									<table class ='table table-borderless table-condensed table-hover'>
										<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF'], ENT_QUOTES); ?>" method="post">
											<div class ="text-center"><h5>Transfert</h5>
						...
						<div class=" col-lg-3 ">
							<div class="well well-sm crea">
								<div class ="text-center"><h5>Créer un Joueur</h5>
								</div>
									<table class ='table table-borderless table-condensed table-hover'>
										<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF'], ENT_QUOTES); ?>" method="post">
											<tr>
											...
											<tr>
												...
												<td><button class ='btn btn-default' type='submit' name='creeJoueur' value='Crée le joueur'> <span class="glyphicon glyphicon-plus"></span> Crée le joueur</button></td>
											</tr>
										</form>
									</table>
								</div>
